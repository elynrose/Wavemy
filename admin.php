<?php
// admin.php - MemoryWaves Admin Dashboard
...
<head>
    ...
    <title>Admin Dashboard - MemoryWaves</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>MemoryWaves Admin Dashboard</h1>
            <p>Manage users, orders, and analytics</p>
            <div class="nav-links">
                <a href="index.html" class="nav-link">← Back to MemoryWaves</a>
