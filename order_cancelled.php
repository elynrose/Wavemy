...
<head>
    ...
    <title>Order Cancelled - MemoryWaves</title>
    <style>
        body {
...
<body>
    <div class="cancel-card">
        ...
        <div style="margin-top: 32px;">
            <a href="index.html" class="btn-primary">Back to MemoryWaves</a>
        </div>
        
        <div style="margin-top: 24px; font-size: 14px; color: #6b7280;">
            <p>You can always order prints later from your MemoryWaves collection.</p>
        </div>
    </div>
</body>
</html>
