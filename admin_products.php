...
<head>
    ...
    <title>Product Management - MemoryWaves Admin</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Manage MemoryWaves print products and pricing</p>
            <div class="nav-links">
            ...
            <div class="product-grid">
                ...
                <div class="product-card <?php echo $product['is_active'] ? '' : 'inactive'; ?>">
                    ...
                    <div class="product-actions">
                        ...
                        <button onclick="testProduct(<?php echo $product['printful_id']; ?>)" 
    ...
    <script>
        function toggleProductStatus(productId, newStatus) {
            if (confirm(`${newStatus === 'true' ? 'Activate' : 'Deactivate'} this product?`)) {
