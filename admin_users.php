...
<head>
    ...
    <title>User Management - MemoryWaves Admin</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Manage MemoryWaves users and their activity</p>
            <div class="nav-links">
                <a href="admin.php?user_id=<?php echo urlencode($userFirebaseUID); ?>" class="nav-link">← Dashboard</a>
                <a href="index.html" class="nav-link">MemoryWaves</a>
        ...
        <div class="users-grid" id="usersGrid">
            ...
            <?php elseif (empty($users)): ?>
                <div style="text-align: center; color: #64748b; padding: 40px;">
                    <h3>No Users Yet</h3>
                    <p>No MemoryWaves users have created memories yet.</p>
                </div>
            <?php else: ?>
